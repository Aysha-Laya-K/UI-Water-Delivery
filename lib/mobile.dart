...
import 'otp.dart'; // Replace with the correct import path
                  ...
                  child: Padding(
                    ...
                    child: TextField(
                      decoration: InputDecoration(
                        labelText: 'Mobile Number', // Use labelText
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => OTPPPage(), // Replace OTPPage with your OTP page class
                      ));
                    },
